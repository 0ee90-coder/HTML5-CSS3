...
// for - in (배열의 인덱스 하나씩 가져와 반복)
for (let i in arrays3){
    console.log(i, arrays3[i]);
}

// for - of (배열의 아이템(값)을 하나씩 가져와 반복) = for each가 이것
...
console.log(shiftValue, newArray);
...
console.log(spliceValue, newArray);
